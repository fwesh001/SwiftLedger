...
class LoansPage(QWidget):
    ...
    def __init__(self, db_path: str = "swiftledger.db"):
        ...
        repayments_filter_row.setHorizontalSpacing(10)
        repayments_filter_row.setVerticalSpacing(8)
        ...
        repayments_filter_row.addWidget(QLabel("Scope:"), 0, 0)
        repayments_filter_row.addWidget(self.combo_repay_scope, 0, 1)
        ...
        repayments_filter_row.addWidget(QLabel("Status:"), 0, 2)
        repayments_filter_row.addWidget(self.combo_repay_status, 0, 3)
        ...
        action_row.addWidget(QLabel("Post Repayment:"), 0, 0)
        action_row.addWidget(self.input_repay_amount, 0, 1)
        ...
        action_row.addWidget(self.combo_repay_mode, 0, 2)
        ...
        action_row.addWidget(self.input_repay_ref, 0, 3)
    ...
    def _effective_member_limit(self, total_savings: float) -> float:
        return float(self.loan_multiplier) * float(total_savings)
