...
class ReportsPage(QWidget):
    ...
    def __init__(self, db_path: str = "swiftledger.db"):
        ...
        self._last_member_pdf_path = ""
        self._last_society_pdf_path = ""
        self._build_ui()
    ...
    def _preview_member_pdf(self) -> None:
        if self._last_member_pdf_path and os.path.isfile(self._last_member_pdf_path):
            self._open_pdf_preview(self._last_member_pdf_path)
            return

        QMessageBox.information(
            self,
            "Preview Member Statement",
            "Please generate a member statement first.",
        )

    def _preview_society_pdf(self) -> None:
        if self._last_society_pdf_path and os.path.isfile(self._last_society_pdf_path):
            self._open_pdf_preview(self._last_society_pdf_path)
            return

        QMessageBox.information(
            self,
            "Preview Society Summary",
            "Please generate a society summary first.",
        )
    ...
    def _generate_member_pdf(self) -> None:
        ...
        self._last_member_pdf_path = path
    ...
    def _generate_society_pdf(self) -> None:
        ...
        self._last_society_pdf_path = path
